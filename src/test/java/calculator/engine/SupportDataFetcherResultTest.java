...
public class SupportDataFetcherResultTest {
    ...
    public void DataFetcherResultTest(){
        DataFetcher commodityListDataFetcher = environment -> {
        ...
        ParseAndValidateResult validateResult = Validator.validateQuery(query, graphqlSource.wrappedSchema(), ConfigImpl.newConfig().build());
        ...
        ExecutionInput skipInput = ExecutionInput
                ...
                .build();
        ExecutionResult executionResult = graphqlSource.graphQL().execute(skipInput);
