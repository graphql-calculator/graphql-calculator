...
// */
//@Internal
//public class ExecutionEngineStateParserOld implements QueryVisitor {
//
...
//        handle(true, null, visitorEnv.getParentEnvironment(), pathList, stateBuilder);
//
//        // 当前节点代表的 Node Task
//        String absolutePath = visitPath(visitorEnv);
//        pathList.add(absolutePath);
